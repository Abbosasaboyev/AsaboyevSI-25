        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-1 col-md-offset-6 col-xs-2">
                    <button class="btn btn-primary btn-authorization btn-danger" onclick="openForm()">Login</button>
                </div>
                <div class="col-md-1 col-md-offset-1 col-xs-4 text-center">
            ...
            <div class="jumbotron">
                <h1><small>In the hall of the</small></br>
                    ...
                    <?php echo mb_substr ("<p>This is a simple hero unit, a simple jumbotron-style component for<br>
                        calling extra attention to featured content or information.</p>",0,50);'...'
                         ?>
                ...
                <div class="col-md-6 opaline">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <p class="lead">
                                <i>Donec sed odio dui. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.</i>
                            </p>
                            <p>
                                <i>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.</i>
                            </p>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="mymail" class="form-control" placeholder="Your Email Here...">
                            <br>
                            <button type="submit" class="btn btn-danger">Submit Newsletter</button>
        </form>
                        </div>
                    </div>
                </div>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h3>Your Logo</h3>
                <p>© 2021-<?php  echo 'date';?>  Your Company. Designed and Developed by
                    <a target="_blank" href="http://www.themeinthebox.com">ThemeintheBox.com</a></p>
            </div>
            <div class="col-md-4">
                <p class="text-right social">
                    <i class="typcn typcn-social-facebook-circular"></i><i class="typcn typcn-social-twitter-circular"></i><i class="typcn typcn-social-tumbler-circular"></i><i class="typcn typcn-social-github-circular"></i><i class="typcn typcn-social-dribbble-circular"></i>
                </p>
            </div>
        </div>
    </div>
